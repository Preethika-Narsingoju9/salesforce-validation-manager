...
Backend
src/main/java/com/cloudvandana/backend/ │ ├── controller/ │ └── AuthController.java │ ├── service/ │ └── SalesforceService.java │ ├── dto/ │ ├── TokenResponse.java │ └── ValidationRuleResponse.java │ ├── config/ │ ├── AppConfig.java │ └── SecurityConfig.java │ └── BackendvandanaApplication.java
...
Enable scopes: Access and manage your data (API) Perform requests on your behalf
🔄 OAuth Flow
...
👨‍💻 Author Navya sri Narsingoju -CloudVandana Associate Software Engineer Assignment Project

✅ Final Status

✔ Salesforce OAuth Login ✔ Fetch Validation Rules ✔ Toggle Validation Rules ✔ Full Stack Integration Completed ✔ Working End-to-End Flow
